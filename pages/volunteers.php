<?php
/**
 * Harvest Baptist Church Antipolo - Visitation Volunteers List (Password Protected)
 */
...
if (!isset($_SESSION['volunteers_authenticated']) || $_SESSION['volunteers_authenticated'] !== true) {
    ...
    <head>
        ...
        <title>Volunteers Login - Harvest Baptist Church Antipolo</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Visitation Volunteers - Harvest Baptist Church Antipolo</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
